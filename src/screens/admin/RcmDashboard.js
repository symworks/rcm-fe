...
const Dashboard = (props) => {
  const { loadingPage, isLoggedin } = props;
  const { authState } = React.useContext(AuthContextTemp);

  const [ cardData, setCardData ] = React.useState([...sparkleCardData]);
              ...
              <div className="card">
                ...
                <div className="body">
                  ...
                  >
                    ...
                    <span>
                      <a title="" href="#!">Katherine Lumaad</a> Oakland, CA
                    </span>
                    <div className="msg">
                      <p>
                        I'm speaking with myself, number one, because I have a
                  ...
                  <div className="timeline-item warning" date-is="21-02-2018">
                    ...
                    <span>
                      <a title="" href="#!">Gary Camara</a> San Francisco, CA
                    </span>
                    <div className="msg">
                      <p>
                        I'm speaking with myself, number one, because I have a
