            ...
            <div className="mail-inbox">
              <div className="mail-left collapse" id="email-nav">
                ...
                <div className="mail-side">
                  ...
                  <h3 className="label">
                    Labels{" "}
                    <a className="float-right m-r-10" title="Add New Labels" href="#!">
              ...
              <div className="mail-right">
                ...
                <div className="mail-action clearfix">
                  <div className="pull-left">
                    ...
                    <div className="btn-group mr-1">
                      <a className="btn btn-outline-secondary btn-sm hidden-sm" href="#!">
                        Refresh
                      </a>
                      <a className="btn btn-outline-secondary btn-sm hidden-sm" href="#!">
                        Archive
                      </a>
                      <a className="btn btn-outline-secondary btn-sm" href="#!">Trash</a>
                    </div>
                    <div
                      className={
                  ...
                  <ul className="list-unstyled">
                    <li className="clearfix">
                      <div className="mail-detail-left">
                        ...
                        <a className="mail-star active" href="#!">
                          <i className="fa fa-star"></i>
                        </a>
                      </div>
                      <div className="mail-detail-right">
                        <h6 className="sub">
                          <a className="mail-detail-expand" href="#!">Herman Beck</a>{" "}
                    ...
                    <li className="clearfix">
                      <div className="mail-detail-left">
                        ...
                        <a className="mail-star" href="#!">
                          <i className="fa fa-star-o"></i>
                        </a>
                      </div>
                      <div className="mail-detail-right">
                        <h6 className="sub">
                          <a className="mail-detail-expand" href="#!">Mary Adams</a>
                        </h6>
                        <p className="dep">
                    ...
                    <li className="clearfix unread">
                      ...
                      <div className="mail-detail-right">
                        <h6 className="sub">
                          <a className="mail-detail-expand" href="#!">June Lane</a>
                    ...
                    <li className="clearfix">
                      ...
                      <div className="mail-detail-right">
                        <h6 className="sub">
                          <a className="mail-detail-expand" href="#!">Gary Camara</a>
                        </h6>
                        <p className="dep">
                    ...
                    <li className="clearfix">
                      ...
                      <div className="mail-detail-right">
                        <h6 className="sub">
                          <a className="mail-detail-expand" href="#!">Frank Camly</a>
                ...
                <div className="mail-detail-full d-none" id="mail-detail-open">
                  <div className="mail-action clearfix">
                    ...
                    <div className="pull-right ml-auto">
                      <a className="mail-back btn btn-outline-secondary btn-sm" href="#!">
                    ...
                    <div className="media">
                      ...
                      <div className="media-body">
                        ...
                        <p className="mb-0">
                          ...
                          <a className="text-default" href="#!">mail@thememakker.com</a>
                        </p>
                      </div>
                    </div>
                  </div>
