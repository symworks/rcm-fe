...
import { Dropdown, Nav, OverlayTrigger, Toast, Tooltip } from "react-bootstrap";
...
const AdminNavbarMenu = (props) => {
  ...
  const activeMenutabwhenNavigate = (activeKey) => {
    if (
      ...
      activeKey === "/ads_campaign" ||
      activeKey === "/product_order"
      ) {
      ...
      <div id="left-sidebar" className="sidebar" style={{ zIndex: 9 }}>
        <div className="sidebar-scroll">
          ...
          <ul className="nav nav-tabs">
            ...
            <li className="nav-item">
              <a
                className={sideMenuTab[4] ? "nav-link active" : "nav-link"}
                data-toggle="tab"
                onClick={() => {
                  props.onPressSideMenuTab(4);
                }}
                href="#!"
              >
              ...
              >
                  <Nav className="sidebar-nav">
                      <ul className="metismenu">
                          <li id="containerAdminRcmDashboard">
                            <a
                              href="#!"
                              className="has-arrow"
                              onClick={e => {
                            ...
                            <ul className="collapse">
                              <li className={activeKey === "admin" ? "active" : ""}>
                          ...
                          <li id="containerAdminRcmSystem">
                            ...
                            <ul className="collapse">
                              ...
                              <li className={activeKey === "ads_campaign" ? "active" : ""}>
                                <Link to="ads_campaign">Chiến dịch quảng cáo</Link>
                              </li>
                              <li className={activeKey === "product_order" ? "active" : ""}>
                                <Link to="product_order">Đặt hàng</Link>
                              </li>
                            </ul>
                          </li>
                      </ul>
