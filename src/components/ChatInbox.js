              ...
              <div className="chat-header clearfix">
                <div className="row">
                  <div className="col-lg-6">
                    <a data-target="#view_info" data-toggle="modal" href="#!">
                      <img alt="avatar" src={Avatar2} />
                    </a>
                  ...
                  <div className="col-lg-6 hidden-sm text-right">
                    <a className="btn btn-outline-secondary mr-1" href="#!">
                      <i className="icon-camera"></i>
                    </a>
                    <a className="btn btn-outline-primary mr-1" href="#!">
                      <i className="icon-camcorder"></i>
                    </a>
                    <a className="btn btn-outline-info mr-1" href="#!">
                      <i className="icon-settings"></i>
                    </a>
                    <a className="btn btn-outline-warning mr-1" href="#!">
